...
<head>
    ...
    <title>Bg Sourcing IT Suppout Login Form</title>
...
<body class="skin-default card-no-border">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">BG Sourcing</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <section id="wrapper">
        <div class="login-register"
            style="background-image:url({{ asset('/') }}asset/assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('employee.login') }}" method="post" class="form-horizontal form-material"
                        id="loginform">
                        @csrf
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Don't have an account? <a href="{{route('employee.registerForm')}}" class="text-info m-l-5"><b>Sign
                                        Up</b></a>
                            </div>
                        </div>
                    </form>
