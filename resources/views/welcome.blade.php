    ...
    <div
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                ...
                @else
                    ...
                    <a href="{{ route('employee.loginForm') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">User
                        Log in</a>
                    ...
                    @if (Route::has('register'))
                        ...
                        <a href="{{ route('employee.registerForm') }}"
                            class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">User
                            Register</a>
                    @endif
                @endauth
            </div>
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="{{ asset('/') }}assets\assets\images\BG-group.png" alt="">
            </div>
                    ...
                    <div>
                        <div class="card">
                            ...
                            <div class="card-body bg-light">
                                <div class="row">
                                    <div class="col-6">
                                        <h3 class="mt-6 text-xl font-semibold text-gray-900">Pending Work List</h3>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($pendings as $pending)
                                            <tr>
                                                ...
                                                <td>{{ $pending->employee->company->company_name }} <=>
                                                        {{ $pending->employee->department->department_name }}
                                                </td>
                    ...
                    <div>
                        <div class="card">
                            ...
                            <div class="card-body bg-light">
                                <div class="row">
                                    <div class="col-6">
                                        <h3 class="mt-6 text-xl font-semibold text-gray-900">Completed Work List
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($completes as $complete)
                                            <tr>
                                                ...
                                                <td>{{ $complete->employee->company->company_name }} <=>
                                                        {{ $complete->employee->department->department_name }}
                                                </td>
                                                <td class="txt-oflo">{{ $complete->title->problem_title }}</td>
                                                <td><span class="badge bg-success rounded-pill"></span>
                                                    @if ($complete->issue_status == 2)
                                                        <a href=""
                                                            class="badge rounded-pill bg-info">Complete</a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
